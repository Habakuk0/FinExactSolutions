  ...
  return (
    <div>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4" data-testid="text-home-services-title">
              Our Services
            </h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto" data-testid="text-home-services-subtitle">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {services.map((service, index) => {
              ...
              return (
                <Card key={index} className="shadow-lg hover:shadow-xl transition-all duration-200" data-testid={`card-home-service-${index}`}>
                  <CardContent className="p-8 text-center">
                    <div className={`w-16 h-16 ${service.color} rounded-xl flex items-center justify-center mx-auto mb-4`}>
                      <Icon className="h-8 w-8" />
                    </div>
                    <h3 className="text-xl font-semibold text-card-foreground mb-2" data-testid={`text-home-service-title-${index}`}>
                      {service.title}
                    </h3>
                    <p className="text-muted-foreground text-sm" data-testid={`text-home-service-description-${index}`}>
                      {service.description}
                    </p>
                  </CardContent>
                </Card>
      ...
      <section className="py-20 bg-muted">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-6" data-testid="text-home-about-title">
                About Us
              </h2>
              <p className="text-lg text-muted-foreground mb-6" data-testid="text-home-about-description">
      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 to-accent/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4" data-testid="text-home-resources-title">
              Latest Resources
            </h2>
            <p className="text-xl text-muted-foreground" data-testid="text-home-resources-subtitle">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            {blogPosts.map((post, index) => (
              <Card key={index} className="shadow-lg hover:shadow-xl transition-all duration-200" data-testid={`card-home-blog-${index}`}>
                <CardContent className="p-6">
                  <div className="flex items-center text-sm text-muted-foreground mb-3">
                    <Calendar className="h-4 w-4 mr-2" />
                    <span data-testid={`text-home-blog-date-${index}`}>{post.date}</span>
                  </div>
                  <h3 className="text-lg font-semibold text-card-foreground mb-3" data-testid={`text-home-blog-title-${index}`}>
                    {post.title}
                  </h3>
                  <p className="text-muted-foreground text-sm mb-4" data-testid={`text-home-blog-excerpt-${index}`}>
                    {post.excerpt}
                  </p>
                  <button
      ...
      <section className="py-20 bg-secondary text-secondary-foreground">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold mb-4" data-testid="text-home-contact-title">
              Get Started Today
            </h2>
            <p className="text-xl text-secondary-foreground/90 max-w-3xl mx-auto" data-testid="text-home-contact-subtitle">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="text-center" data-testid="home-contact-phone">
              ...
              <p className="text-secondary-foreground/80">+254 700 123 456</p>
            </div>
